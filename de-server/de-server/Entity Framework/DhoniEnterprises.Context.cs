...
namespace de_server.Entity_Framework
{
    ...
    public partial class DhoniEnterprisesEntities : DbContext
    {
        ...
        public virtual int AppUserIncrementInvalidPassword(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AppUserIncrementInvalidPassword", idParameter);
        }
        ...
        public virtual ObjectResult<uspGetUserById_Result> uspGetUserById(Nullable<int> userID)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<uspGetUserById_Result>("uspGetUserById", userIDParameter);
        }
        ...
        public virtual int uspProductPriceByDateCRUD(string crudOperation, Nullable<int> productId, Nullable<System.DateTime> priceDate, Nullable<decimal> price, Nullable<decimal> localPrice, Nullable<int> tr_createdBy, Nullable<int> tr_editedBy)
        {
            var crudOperationParameter = crudOperation != null ?
                new ObjectParameter("crudOperation", crudOperation) :
                new ObjectParameter("crudOperation", typeof(string));
        ...
        public virtual ObjectResult<Nullable<long>> uspTransactionBasicCRUD(string crudOperation, Nullable<long> tr_transactionID, Nullable<System.DateTime> tr_date, Nullable<long> tr_bpBuyerID, Nullable<long> tr_bpSellerID, Nullable<int> tr_productID, string tr_origin, Nullable<decimal> tr_quantity, Nullable<decimal> tr_price, string tr_packing, Nullable<System.DateTime> tr_shipment_start, Nullable<System.DateTime> tr_shipment_end, string tr_fileID, string tr_contractID, string tr_other_info, Nullable<int> tr_createdBy, Nullable<int> tr_editedBy)
        {
            ...
            var tr_quantityParameter = tr_quantity.HasValue ?
                new ObjectParameter("tr_quantity", tr_quantity) :
                new ObjectParameter("tr_quantity", typeof(decimal));
    
            var tr_priceParameter = tr_price.HasValue ?
                new ObjectParameter("tr_price", tr_price) :
                new ObjectParameter("tr_price", typeof(decimal));
        ...
        public virtual int uspTransactionCommissionCRUD(string crudOperation, Nullable<long> tr_transactionID, Nullable<bool> tr_brokerInvolved, Nullable<bool> tr_sellerBroker, Nullable<long> tr_sellerBrokerID, string tr_sellerBroker_comm_type, Nullable<decimal> tr_sellerBroker_comm, Nullable<bool> tr_buyerBroker, Nullable<long> tr_buyerBrokerID, string tr_buyerBroker_comm_type, Nullable<decimal> tr_buyerBroker_comm, Nullable<decimal> tr_own_Commission, string tr_ownCommissionType, Nullable<decimal> tr_difference, Nullable<decimal> tr_discount, Nullable<decimal> tr_netCommission, Nullable<int> tr_createdBy, Nullable<System.DateTime> tr_createdOn, Nullable<int> tr_editedBy, Nullable<System.DateTime> tr_editedOn)
        {
            var crudOperationParameter = crudOperation != null ?
                new ObjectParameter("crudOperation", crudOperation) :
                new ObjectParameter("crudOperation", typeof(string));
            ...
            var tr_sellerBroker_commParameter = tr_sellerBroker_comm.HasValue ?
                ...
                new ObjectParameter("tr_sellerBroker_comm", typeof(decimal));
            ...
            var tr_differenceParameter = tr_difference.HasValue ?
                ...
                new ObjectParameter("tr_difference", typeof(decimal));
    
            var tr_discountParameter = tr_discount.HasValue ?
                new ObjectParameter("tr_discount", tr_discount) :
                new ObjectParameter("tr_discount", typeof(decimal));
    
            var tr_netCommissionParameter = tr_netCommission.HasValue ?
                new ObjectParameter("tr_netCommission", tr_netCommission) :
                new ObjectParameter("tr_netCommission", typeof(decimal));
        ...
        public virtual ObjectResult<Nullable<long>> uspTransactionSecondaryCRUD(string crudOperation, Nullable<long> tr_transactionID, Nullable<long> tr_sec_bpBuyerID, Nullable<long> tr_sec_bpSellerID, Nullable<System.DateTime> tr_sec_date, Nullable<decimal> tr_sec_buyerPrice, Nullable<decimal> tr_sec_sellerPrice, Nullable<decimal> tr_sec_quantity, string tr_sec_otherInfo, Nullable<int> tr_createdBy, Nullable<int> tr_editedBy, Nullable<long> tr_sec_tranID)
        {
            var crudOperationParameter = crudOperation != null ?
                new ObjectParameter("crudOperation", crudOperation) :
                new ObjectParameter("crudOperation", typeof(string));
            ...
            var tr_sec_buyerPriceParameter = tr_sec_buyerPrice.HasValue ?
                ...
                new ObjectParameter("tr_sec_buyerPrice", typeof(decimal));
    
            var tr_sec_sellerPriceParameter = tr_sec_sellerPrice.HasValue ?
                new ObjectParameter("tr_sec_sellerPrice", tr_sec_sellerPrice) :
                new ObjectParameter("tr_sec_sellerPrice", typeof(decimal));
    
            var tr_sec_quantityParameter = tr_sec_quantity.HasValue ?
                new ObjectParameter("tr_sec_quantity", tr_sec_quantity) :
                new ObjectParameter("tr_sec_quantity", typeof(decimal));
        ...
        public virtual int uspUpdateUserById(Nullable<int> userID, string initials, string userEmail, string firstName, string lastName, Nullable<bool> isSuperUser, string designation)
        {
            var userIDParameter = userID.HasValue ?
                new ObjectParameter("userID", userID) :
                new ObjectParameter("userID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("uspUpdateUserById", userIDParameter, initialsParameter, userEmailParameter, firstNameParameter, lastNameParameter, isSuperUserParameter, designationParameter);
        }
    }
}
